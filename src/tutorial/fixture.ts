...
const P0_HAND_IDS = [
  'hearts-9', 'spades-9', 'clubs-9',
  'diamonds-3', 'diamonds-4', 'diamonds-5', 'diamonds-6',
  'diamonds-9',
];
...
const DRAW_TOP_IDS = ['clubs-2', 'diamonds-7'];

/**
 * Hand-crafted deterministic state for the interactive tutorial: same 52-card
