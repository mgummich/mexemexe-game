...
describe('parseSave', () => {
  ...
  it('round-trips a valid v1 save', () => {
    const save: Save = {
      version: 1,
      settings: { muted: true, sfxVolume: 10, musicVolume: 20, musicEnabled: false, musicContextAware: false, reducedMotion: true, locale: 'en', largeText: true, helperMode: 'beginner', batterySaver: true, aiDifficulty: 'expert', aiSpeed: 'slow', aiExplain: 'detailed', timerTickSound: false, haptics: false, blitz: true },
...
describe('loadSave', () => {
  ...
  it('migrates the old unversioned settings key and removes it', () => {
    ...
    expect(result).toEqual({ version: 1, settings: { ...oldSettings, musicEnabled: false, musicContextAware: true, largeText: false, helperMode: 'standard', batterySaver: false, aiDifficulty: 'smart', aiSpeed: 'normal', aiExplain: 'simple', timerTickSound: true, haptics: false, blitz: false }, progress: DEFAULT_PROGRESS, cosmetics: DEFAULT_COSMETICS });
